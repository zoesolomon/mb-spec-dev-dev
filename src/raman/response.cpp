...
void do_autocorr(const char* filename, const int traj_num, const double int_max, const bool depol)
{
...
int main(int argc, char **argv)
{
    ...
    // depol = true
    bool depol = sys.GetRamanResponse();

    for (int i = 1; i < argc - 1; ++i)
        do_autocorr(argv[i], i - 1, int_max, depol);
